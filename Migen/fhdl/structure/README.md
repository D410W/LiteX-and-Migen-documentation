...
- ClockSignal
- ResetSignal
- ClockDomain - Used to specify other clocks for any usage. It encapsulates a clock wire, an optional reset wire, and the clock's timing properties.
- If
- Mux
- Case
- Array

Each of these classes have their in-code description which explain their usage in the Migen repos.

https://github.com/m-labs/migen/blob/master/migen/fhdl/structure.py \
https://git.m-labs.hk/M-Labs/migen/src/branch/master/migen/fhdl/structure.py
